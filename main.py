...
def get_all_sensitive(token: str = Depends(verify_token)):
    return {"record": {"user": {"name": "Alice Johnson","email": "alice.johnson@acme-corp.com","phone": "+1 (212) 555-0147","ssn": "372-82-9156"},"payment": {"card_number": "4532 1151 0823 9147","cvv": "412"},"aws": {"access_key_id": "AKIAIOSFODNN7EXAMPLE","secret_access_key": "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY"},"github_token": "ghp_TEST1234567890abcdefghijklmnopqrst","jwt": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c3JfMDAxIn0.abc123","api_key": "STRIPE_TEST_KEY_PLACEHOLDER_002"}}
